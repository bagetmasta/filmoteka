        ...
        return `<li class="card-list__item">
                    <a href="" class="card-list__link">
                        ...
                        <h2 class="card-list__title">
                            <span class="card-list__movie-name">${item.original_title}</span>
                            ${renderGenreMovieByName(item)} | ${new Date(item.release_date).getFullYear()}
                            <span class="card-list__ratimg">${item.vote_average.toFixed(1)}</span>
                        </h2>
                    </a>
                </li>
            `
